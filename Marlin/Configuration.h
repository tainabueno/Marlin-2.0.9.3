...
#define STRING_CONFIG_H_AUTHOR "(Taina Bueno 22-02-2022 SKR 1.4)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "tainabueno3D"
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstopprobe.
